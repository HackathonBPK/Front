...
const Navbar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 right-0 h-20 backdrop-blur-sm bg-[rgba(75,108,134,90%)] z-50">
      {/* <div className="w-full bg-primary p-2 z-50"> */}
      <div className="container mx-auto px-4 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <ul className="hidden lg:flex gap-x-6 text-white ">
            <li>
              <Link href="/meusCursos" className="hover:cursor-pointer">
                <p>Meus Cursos</p>
              </Link>
            </li>
            <li>
