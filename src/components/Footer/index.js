...
const Footer = () => {
  return (
    <footer className="flex h-auto bg-contain  bg-repeat-round justify-center items-center bg-[#10171E] shadow-2xl shadow-neutral-200 text-white py-10 relative overflow-hidden bg-footer">
